...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='cfgs/nuscenes_models/KDcbgs_voxel01_centerpoint.yaml', help='specify the config for training')

    parser.add_argument('--batch_size', type=int, default=1, required=False, help='batch size for training')
    parser.add_argument('--workers', type=int, default=4, help='number of workers for dataloader')
    parser.add_argument('--extra_tag', type=str, default='default', help='extra tag for this experiment')
    # parser.add_argument('--ckpt', type=str, default='/home/ubuntu2004/code/lfy/SparseKD_nus/output/nuscenes_models/KDcbgs_voxel01_centerpoint/default/ckpt/checkpoint_epoch_30.pth', help='checkpoint to start from')
    parser.add_argument('--ckpt', type=str, default='/home/ubuntu2004/code/lfy/SparseKD_nus/output/cbgs_voxel01_centerpoint_nds_6454.pth', help='checkpoint to start from')
